...
Workshop notes (Tuesday 9-11am) can be found **[[here (online only)]](notes.html)**.
...
Find a critical Z value, from a normal distribution, given a type I error rate $\alpha = 0.05$:
